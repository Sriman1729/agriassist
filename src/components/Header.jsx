...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <header
          className="sticky top-0 z-50 backdrop-blur-sm bg-white/90 dark:bg-gray-900/90 text-gray-800 dark:text-gray-100 shadow-sm border-b border-gray-200/50 dark:border-gray-700/50 transition-all duration-500"
        >
                        ...
                        <div key={group}>
                          ...
                          {filtered.map((lang) => (
                            <button
                              ...
                              className="w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-600 transition"
                            >
                              {lang.label}
                            </button>
                          ))}
          ...
          {/* Mobile Nav */}
          {mobileMenu && (
            <div className="md:hidden bg-white dark:bg-gray-800 px-4 py-3 border-t border-gray-200 dark:border-gray-700">
              {navLinks.map((link) => {
                const isActive = location.pathname === link.to;
                return (
                  <Link
