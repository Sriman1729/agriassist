...
import farmingCalendars from "../data/farmingData";
...
export default function Calendar() {
  ...
  const pdfRef = useRef(null); // 📌 reference for PDF capture
  ...
  const renderRegionCard = (region, monthData) => (
    <div className="bg-card text-card-foreground rounded-lg shadow-lg p-6 mb-6">
      ...
      <div className="mb-6">
        ...
        <p className="bg-yellow-50 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 p-3 rounded-lg">
          {monthData.weather}
        </p>
      </div>
  ...
  return (
    // 📌 Wrap the entire exportable content
    <div ref={pdfRef} className="max-w-6xl mx-auto p-6 bg-background text-foreground">
      ...
      {/* Region Selector */}
      <div className="bg-card text-card-foreground rounded-lg shadow-lg p-4 mb-6 flex justify-center gap-4 flex-wrap">
          ...
          <div>
            ...
            <div className="bg-card text-card-foreground rounded-lg shadow-lg p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-blue-50 dark:bg-blue-900 rounded-lg border-l-4 border-blue-400 dark:border-blue-600">
                ...
                <div className="p-3 bg-yellow-50 dark:bg-yellow-900 rounded-lg border-l-4 border-yellow-400 dark:border-yellow-600">
